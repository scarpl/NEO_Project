...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f" {self.fullname}, {'is' if self.hazardous else 'is not'} potentially hazardous."
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"At {self.time_str}, '{self.neo.fullname}' have a distance from Earth of {self.distance:.2f} and it is approaching with velocity of \
